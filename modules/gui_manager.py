...
def crear_ventana():
    ...
    ventana = tk.Tk()
    ventana.title(" Control por voz - Versión modular")
    ventana.geometry("500x350")
    ventana.config(bg="#1e1e1e")

    titulo = tk.Label(ventana, text="CONTROL POR VOZ (VOSK)",
                      font=("Arial", 16, "bold"), bg="#1e1e1e", fg="#00ffcc")
    titulo.pack(pady=10)

    texto_label = tk.Label(ventana, text="Haz clic en Escuchar y da un comando...",
    ...
    estado_motor = tk.Label(ventana, text="Motor: OFF", font=("Arial", 16, "bold"),
